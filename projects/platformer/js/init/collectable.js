(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.steve, 200, 170, 6, 1.0);
        collectable.create(type.steve, 250, 180, 10,1.0);
        collectable.create(type.max, 300, 200, 15,1.0);
        collectable.create(type.max, 500, 340, 18,1.0);
